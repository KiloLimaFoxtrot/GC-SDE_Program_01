# import unittest
# import clock
# # There is some issue with the below import statement, from a windows
# # pyCharm...
...
#         clock = Clock()
#         self.assertEqual(clock.__str__(), "0:0:0", "default clock not set to 0:0:0")
#
#     def test_init_235959(self):
#         """Does clock set properly to 1 second before midnight?"""
#         clock = Clock(23, 59, 59)
#         self.assertEqual(clock.__str__(), "23:59:59", "clock not set to 23:59:59")
#
...
#         # I imported the name Clock() from some suggested source...
#         # it may not be the right source..
#         clock = Clock()
#         clock.set_hour(23)
...
#         now = datetime.now()
#         self.assertLessEqual(now.hour, clock.hour())
#         self.assertLessEqual(now.minute, clock.minute())
#         self.assertLessEqual(now.second, clock.second())
#         print(clock)
